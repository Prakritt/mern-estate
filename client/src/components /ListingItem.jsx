...
function ListingItem({listing}) {
  return (
    <div className='bg-white shadow-md hover:shadow-lg transition-shadow duration-200 overflow-hidden rounded-lg
    w-full sm:w-[330px]'>
        <Link to={`/listing/${listing._id}`}>
            ...
            hover:scale-105 transition-scale duration-300'
             ...
             <div className="p-3 flex flex-col gap-2 w-full">
                ...
                <div className="flex gap-2 font-bold text-slate-700 text-xs">
